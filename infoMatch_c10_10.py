...
from dataset.cifar_cutmix_c10_10 import DATASET_GETTERS
...
def main():
    ...
    if args.num_labeled == 10 and args.dataset == 'cifar10':
        fixmatch_index = [
            ...
            [4255, 8580, 11501, 12598, 29349, 32103, 33759, 38639, 46789, 48675],
...
def train(args, labeled_trainloader, unlabeled_trainloader, test_loader,
    ...
    if args.resume:  # 简要输出最优模型，resume:path to latest checkpoint (default: none)
        checkpoint = torch.load(args.resume)
        time_p = checkpoint['time_p']
        p_model = checkpoint['p_model']
